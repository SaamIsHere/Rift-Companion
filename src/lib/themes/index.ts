...
export const THEMES: ThemeDefinition[] = [
  ...
  },
  {
    id: "shurima",
    name: "Shurima",
    subtitle: "Sun Disc Gold",
    region: "The Sunken Empire",
    description: "Radiant golden sun disc, ancient dunes & warm golden ascension.",
    swatch: ["#eab308", "#fde047", "#0d0b03"],
    bgFilter: "grayscale(100%) contrast(1.18) brightness(0.92)",
    tintGradient: "linear-gradient(135deg, #facc15 0%, #eab308 45%, #ca8a04 80%, #713f12 100%)",
    tintBlendMode: "color",
    bgBase: "#0d0b03",
    glow: "rgba(234, 179, 8, 0.48)",
    bgGradients: {
      g1: "rgba(234, 179, 8, 0.16)",
      g2: "rgba(202, 138, 4, 0.12)",
      g3: "rgba(250, 204, 21, 0.08)",
    },
    buttonGradient: {
      simFrom: "from-yellow-900/80",
      simVia: "via-amber-700/80",
      simTo: "to-yellow-950/80",
      patchFrom: "from-yellow-600/85",
      patchVia: "via-amber-500/85",
      patchTo: "to-yellow-700/85",
    },
    primaryRgb: {
      50: "254 252 232",
      100: "254 249 195",
  ...
  },
  {
    ...
    region: "Ionia",
    description: "Vibrant sakura blossom pink, twilight magenta & spiritual petals.",
    swatch: ["#f43f8e", "#f472b6", "#14040e"],
    bgFilter: "grayscale(100%) contrast(1.18) brightness(0.9)",
    tintGradient: "linear-gradient(135deg, #f472b6 0%, #ec4899 45%, #db2777 80%, #831843 100%)",
    tintBlendMode: "color",
    bgBase: "#14040e",
    glow: "rgba(244, 63, 142, 0.52)",
    bgGradients: {
      g1: "rgba(244, 63, 142, 0.18)",
      g2: "rgba(236, 72, 153, 0.13)",
      g3: "rgba(251, 113, 133, 0.09)",
    },
    buttonGradient: {
      simFrom: "from-pink-900/80",
      simVia: "via-rose-800/80",
      simTo: "to-pink-950/80",
      patchFrom: "from-pink-600/85",
      patchVia: "via-rose-500/85",
      patchTo: "to-pink-700/85",
    },
    primaryRgb: {
      50: "253 242 248",
      100: "252 231 243",
