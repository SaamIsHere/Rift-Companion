...
export const THEMES: ThemeDefinition[] = [
  ...
  },
  {
    ...
    description: "Sun-drenched golden dunes, fine desert sand & radiant celestial ascension.",
    swatch: ["#facc15", "#fef08a", "#0e0b04"],
    bgFilter: "grayscale(100%) contrast(1.18) brightness(0.95)",
    tintGradient: "linear-gradient(135deg, #fef08a 0%, #facc15 35%, #eab308 65%, #a16207 92%, #78350f 100%)",
    tintBlendMode: "color",
    bgBase: "#0e0b04",
    glow: "rgba(250, 204, 21, 0.52)",
    bgGradients: {
      g1: "rgba(250, 204, 21, 0.18)",
      g2: "rgba(234, 179, 8, 0.13)",
      g3: "rgba(254, 240, 138, 0.10)",
    },
    buttonGradient: {
      simFrom: "from-yellow-900/80",
      simVia: "via-yellow-800/70",
      simTo: "to-amber-950/80",
      patchFrom: "from-yellow-500/85",
      patchVia: "via-yellow-400/85",
      patchTo: "to-yellow-600/85",
    },
    primaryRgb: {
      50: "254 252 232",
      100: "254 249 195",
  ...
  },
  {
    ...
    swatch: ["#f472b6", "#fbcfe8", "#12050d"],
    bgFilter: "grayscale(100%) contrast(1.15) brightness(0.92)",
    tintGradient: "linear-gradient(135deg, #fce7f3 0%, #fbcfe8 25%, #f472b6 60%, #db2777 88%, #9d174d 100%)",
    tintBlendMode: "color",
    bgBase: "#12050d",
    glow: "rgba(244, 114, 182, 0.50)",
    bgGradients: {
      g1: "rgba(244, 114, 182, 0.18)",
      g2: "rgba(251, 207, 232, 0.14)",
      g3: "rgba(244, 114, 182, 0.08)",
    },
    buttonGradient: {
      simFrom: "from-pink-900/75",
      simVia: "via-pink-800/65",
      simTo: "to-rose-950/80",
      patchFrom: "from-pink-500/85",
      patchVia: "via-pink-400/85",
      patchTo: "to-pink-600/85",
    },
    primaryRgb: {
      50: "255 245 248",
      100: "254 235 243",
